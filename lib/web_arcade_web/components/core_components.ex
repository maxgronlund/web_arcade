defmodule WebArcadeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WebArcadeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WebArcadeWeb.Gettext, "errors", msg, opts)
    end
  end
